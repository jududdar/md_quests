...
eq.debug("Shuttle spawned! Name is: Shuttle III Time is: " .. hour ..":" .. minute .. "", 1);
...
eq.debug("Shuttle to butcher (4) has reached its destination! Name is: Shuttle III Time is: " .. hour ..":" .. minute .. "", 1);
