...
elseif(e.other:GetLevel() > 4 and  **You turn in:**   <img style="background:url(/static/icons/blank_slot.gif);width:20px;height:20px;" src="/static/icons/item_906.png" alt="" /> <a
...
elseif(e.other:GetLevel() > 5 and  **You turn in:**   <img style="background:url(/static/icons/blank_slot.gif);width:20px;height:20px;" src="/static/icons/item_906.png" alt="" /> <a
...
elseif(e.other:GetLevel() > 6 and  **You turn in:**   <img style="background:url(/static/icons/blank_slot.gif);width:20px;height:20px;" src="/static/icons/item_906.png" alt="" /> <a
