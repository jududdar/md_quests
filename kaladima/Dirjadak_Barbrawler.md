...
[Dirjadak Barbrawler](/npc/60018) is a level 61 Dwarf GM Warrior that spawns in [South Kaladim](/zone/60).
...
if(eq.is_the_shadows_of_luclin_enabled() and  **You turn in:**   <img style="background:url(/static/icons/blank_slot.gif);width:20px;height:20px;" src="/static/icons/item_1067.png" alt="" /> <a
...
Your faction standing with [Craknek Warriors](/faction/232) got worse (<span class='text-danger'>-5</span>)
 ...
 &#127873; **You receive:**  <img style="background:url(/static/icons/blank_slot.gif);width:20px;height:20px;" src="/static/icons/item_569.png" alt="" /> <a
                                href="/item/26076" data-url="26076" class="tooltip-link link">Gem-Etched Battle Axe</a> (+0 exp)
