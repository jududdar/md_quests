...
eq.get_entity_list():GetMobByNpcTypeID(202301):Say("Nothing at all. Do you think that he led us astray?"); 
...
eq.get_entity_list():GetMobByNpcTypeID(202301):Say("I think we should just do what [Tarerd] wants us to do."); 
