...
local Red_Wine =  **You turn in:**  <img style="background:url(/static/icons/blank_slot.gif);width:20px;height:20px;" src="/static/icons/item_704.png" alt="" /> <a
                                href="/item/13030" data-url="13030" class="tooltip-link link">Red Wine</a> x 1

if **Faction** >= Indifferent and  **You turn in:**   <img src='/static/icons/item_644.png' width='14' height='14'/>  7 platinum ) then
