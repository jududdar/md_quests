...
if (eq.is_the_shadows_of_luclin_enabled() and  **You turn in:**   <img style="background:url(/static/icons/blank_slot.gif);width:20px;height:20px;" src="/static/icons/item_868.png" alt="" /> <a
                                href="/item/10989" data-url="10989" class="tooltip-link link">Parchment to Glerbella</a> ) then
