...
[Lord Nagafen](/npc/32040) is a level 55 Dragon Warrior that spawns in [Nagafen's Lair (Instance)](/zone/1032).

Their primary faction is [Nagafen](/faction/249).local SpawnX = 0;
local SpawnY = 0;
local SpawnZ = 0;
local SpawnH = 0;
