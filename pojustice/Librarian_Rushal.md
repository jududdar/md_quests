...
Their primary faction is [Prisoners of Justice](/faction/1627).
...
e.self:Say("According to the booksss that I had accesss to, this place is the embodiment of order within the universe.  Ever sssince the first mote of ordering of existence, springing out of the chaosss, so too did the Plane of Jussstice exist, to serve and judge the ordering.  It issss said in the Great Books that it shall remain until the end of Order itssself, until everything once again is anarchy.  Until then, there are the [Judges].",18);
