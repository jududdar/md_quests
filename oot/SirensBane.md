...
eq.debug("Boat to Freeport (60) has reached its destination! Name is: SirensBane Time is: " .. hour ..":" .. minute .. "", 1);
...
eq.debug("Boat to Butcher (61) has reached its destination! Name is: SirensBane Time is: " .. hour ..":" .. minute .. "", 1);
