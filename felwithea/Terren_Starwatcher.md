...
Their primary faction is [King Tearis Thex](/faction/279).
...
>**Terren Starwatcher says:** Welcome friend! Have you come to the Temple of Tunare to give praise?
...
if(eq.is_the_shadows_of_luclin_enabled() and  **You turn in:**   <img style="background:url(/static/icons/blank_slot.gif);width:20px;height:20px;" src="/static/icons/item_1049.png" alt="" /> <a
...
elseif(eq.is_the_shadows_of_luclin_enabled() and  **You turn in:**   <img style="background:url(/static/icons/blank_slot.gif);width:20px;height:20px;" src="/static/icons/item_578.png" alt="" /> <a
