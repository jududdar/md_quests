...
[Vurgo](/npc/80016) is a level 34 Erudite Wizard that spawns in [Temple of Solusek Ro](/zone/80).
...
elseif **Faction** >= Indifferent and  **You turn in:**   <img style="background:url(/static/icons/blank_slot.gif);width:20px;height:20px;" src="/static/icons/item_777.png" alt="" /> <a
                                ...
                                href="/item/18945" data-url="18945" class="tooltip-link link">A note</a>,  <img src='/static/icons/item_645.png' width='14' height='14'/>  300 gold ) then 
