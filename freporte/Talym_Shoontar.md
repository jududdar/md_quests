...
[Talym Shoontar](/npc/1166) is a level 14 Barbarian Warrior that spawns in [East Freeport](/zone/10).

Their primary faction is [Karana Residents](/faction/345).local factionId = 0;
...
e.self:AddToHateList(eq.get_entity_list():GetMobByNpcTypeID(10186),100); 
