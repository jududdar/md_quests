...
if(eq.is_the_shadows_of_luclin_enabled() >= 4.0) then
...
elseif(eq.is_the_shadows_of_luclin_enabled() and  **You turn in:**   <img style="background:url(/static/icons/blank_slot.gif);width:20px;height:20px;" src="/static/icons/item_886.png" alt="" /> <a
