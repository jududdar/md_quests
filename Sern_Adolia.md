...
>**Sern Adolia says:** I hope you have a good reason for disturbing my contemplations.
...
if **Faction** >= Indifferent and  **You turn in:**   <img style="background:url(/static/icons/blank_slot.gif);width:20px;height:20px;" src="/static/icons/item_820.png" alt="" /> <a
