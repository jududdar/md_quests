...
Their primary faction is [The Spurned](/faction/363).
...
elseif(e.other:GetClass() == 2 and e.other:GetRace() == 6 and eq.is_the_shadows_of_luclin_enabled()) then
...
if(eq.is_the_shadows_of_luclin_enabled() and  **You turn in:**   <img style="background:url(/static/icons/blank_slot.gif);width:20px;height:20px;" src="/static/icons/item_864.png" alt="" /> <a
...
>**High Priestess Alexandria says:** Let it be known that on this day Soandso, you have proven both your devotion to I Alexandriana High Priestess of Neriak and the dark Lord Innoruuk. Pride yourself in being one of the youngest clerics that is able to draw the power of Innoruuk to call the dead back to where they have fallen. Take this mace Soandso, you have most certainly earned it.
