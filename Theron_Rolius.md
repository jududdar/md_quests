...
local dmh =  **You turn in:**  <img style="background:url(/static/icons/blank_slot.gif);width:20px;height:20px;" src="/static/icons/item_550.png" alt="" /> <a
                                href="/item/13921" data-url="13921" class="tooltip-link link">Damaged Militia Helm</a> x 1



if **Faction** >= Dubious and (dmh > 0))  then 
