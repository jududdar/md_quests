...
elseif **Faction** >= Warmly +150 and  **You turn in:**   <img style="background:url(/static/icons/blank_slot.gif);width:20px;height:20px;" src="/static/icons/item_865.png" alt="" /> <a
                                href="/item/18459" data-url="18459" class="tooltip-link link">Neh`Ashiirs Diary</a> ) then 
...
Your faction standing with [Truespirit](/faction/404) got better (<span class='text-success'>+1000</span>)

 &#127873; **You receive:** No item given (+75000 exp)

 

elseif **Faction** >= Ally +800 and  **You turn in:**   <img style="background:url(/static/icons/blank_slot.gif);width:20px;height:20px;" src="/static/icons/item_1234.png" alt="" /> <a
