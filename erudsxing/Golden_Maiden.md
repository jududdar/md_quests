...
eq.debug("Boat to Qeynos (5) has reached its destination! Name is: Golden Maiden Time is: " .. hour ..":" .. minute .. "", 1);
...
eq.debug("Boat to Erud (7) has reached its destination! Name is: Golden Maiden Time is: " .. hour ..":" .. minute .. "", 1);
