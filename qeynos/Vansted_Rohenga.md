...
[Vansted Rohenga](/npc/1127) is a level 61 Human GM Cleric that spawns in [South Qeynos](/zone/1).
...
>**Vansted Rohenga says:** Pleased to meet you Soandso. I am Vansted Rohenga High Priest of Karana. I have spent all of my years studying the ways of the Cleric in our wonderful Temple of Thunder. We receive many new recruits every day and it is my duty to train them.
...
if(eq.is_the_shadows_of_luclin_enabled() and  **You turn in:**   <img style="background:url(/static/icons/blank_slot.gif);width:20px;height:20px;" src="/static/icons/item_682.png" alt="" /> <a
